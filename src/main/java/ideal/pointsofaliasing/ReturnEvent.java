...
public class ReturnEvent<V> extends Event<V> {
	...
	public int hashCode() {
		final int prime = 31;
		int result = 1;
		result = prime * result + ((callSite.getContents() == null) ? 0 : callSite.hashCode());
		result = prime * result + ((d2.getAccessGraph() == null) ? 0 : d2.hashCode());
		result = prime * result + ((d3.getAccessGraph() == null) ? 0 : d3.hashCode());
		result = prime * result + ((exitStmt.getContents() == null) ? 0 : exitStmt.hashCode());
		result = prime * result + ((returnSite.getContents() == null) ? 0 : returnSite.hashCode());
		return result;
//		return 1;
	}
